...
greplace: /usr/local/lib/libopencv_calib3d.so
greplace: /usr/local/lib/libopencv_contrib.so
greplace: /usr/local/lib/libopencv_core.so
greplace: /usr/local/lib/libopencv_features2d.so
greplace: /usr/local/lib/libopencv_flann.so
greplace: /usr/local/lib/libopencv_gpu.so
greplace: /usr/local/lib/libopencv_highgui.so
greplace: /usr/local/lib/libopencv_imgproc.so
greplace: /usr/local/lib/libopencv_legacy.so
greplace: /usr/local/lib/libopencv_ml.so
greplace: /usr/local/lib/libopencv_nonfree.so
greplace: /usr/local/lib/libopencv_objdetect.so
greplace: /usr/local/lib/libopencv_photo.so
greplace: /usr/local/lib/libopencv_stitching.so
greplace: /usr/local/lib/libopencv_superres.so
greplace: /usr/local/lib/libopencv_ts.so
greplace: /usr/local/lib/libopencv_video.so
greplace: /usr/local/lib/libopencv_videostab.so
